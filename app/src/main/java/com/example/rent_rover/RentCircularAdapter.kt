...
class RentCircularAdapter(private val rentCircularList: List<RentCircular>) :
    RecyclerView.Adapter<RentCircularAdapter.RentCircularViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RentCircularViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.circular_layout, parent, false)
    ...
    class RentCircularViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        // ViewPager2 and TabLayout for image slider and dot indicator
